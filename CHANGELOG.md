...
- **Journal display hides wikilinks** — viewing pane now strips auto-inserted chapter wikilinks and reply lines from rendered output (wikilinks remain in saved .md files for Obsidian)
